...
export class CarEditModal extends Component {
    state = {
        name: '',
        type: '',
        color: '',
    ...
    updateCar = async () => {
        try {
            await Api.car.updateCar(this.state);
        ...
        return (
            <Modal bsSize="large" show={show} onHide={onHide} backdrop="static">
                ...
                <Modal.Footer className="modal-footer d-inline">
                    <Button bsStyle="primary" className="pull-left" size="large" onClick={() => this.updateCar()}><Glyphicon glyph='floppy-disk' /> Save</Button>
