...
export class EmployeeAddModal extends Component {
    state = {
        name: '',
        isDriver: false,
        errors: undefined
    ...
    addEmployee = async () => {
        try {
            await Api.employee.addEmployee(this.state);
        ...
        return (
            <Modal bsSize="large" show={show} onHide={onHide} backdrop="static">
                ...
                <Modal.Footer className="modal-footer d-inline">
                    <Button bsStyle="primary" className="pull-left" size="large" onClick={() => this.addEmployee()}><Glyphicon glyph='floppy-disk' /> Save</Button>
